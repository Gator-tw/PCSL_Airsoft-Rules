...
Walls may be constructed of many different materials. The field section of the walls may have coarse plastic mesh or wire that allows competitors to see through the wall, or wood/coroplast which completely blocks lines of sight. Whether or not the wall is a visual barrier or just a physical barrier, it is never permissible to engage targets through a wall. In cases where ROs suspect competitors of cheating by shooting through the near-edge of a wall, the RM must be called and, after consideration, a **Strike** or **Match DQ** may be issued for unsportsmanlike conduct ([Section 13.1](<13_Two-Strike System.md#id-13.1-suspected-cheating-or-unsportsmanlike-conduct>) or [Section 15.7](<15_Match Disqualifications.md#id-15.7-blatant-unsportsmanlike-conduct-attempts-to-cheat-or-aggressive-behavior>)).
...
Note that if the steel target is completely obscured by the barrel from the specific shooting position, competitors may never shoot through the barrel to hit the steel target. In such cases, the RM must be called to make a judgement. At a minimum, no engagement shall be awarded per [Section 12.5](<12_Procedural Penalties.md#id-12.5-engaging-targets-from-the-wrong-position>), and a **Strike** or **Match DQ** for unsportsmanlike conduct may be assessed per [Section 13.1](<13_Two-Strike System.md#id-13.1-suspected-cheating-or-unsportsmanlike-conduct>) or [Section 15.7](<15_Match Disqualifications.md#id-15.7-blatant-unsportsmanlike-conduct-attempts-to-cheat-or-aggressive-behavior>).
...
The K-Zone targets may not be used at Level 2 events or higher ([Section 10.1.4.1](<10_Targets.md#id-10.1.4.1-k-zone-legacy-usage>)).
...
However, a single “presentation” may be used to denote an “option” target, such as a target that can be engaged with either handgun or rifle.
...
See [Section 1.8](<01_Range Safety & Procedures.md#id-1.8-minimum-target-engagement-distance-for-steel-targets>) for minimum allowable shooting position distances.
...
##### 9.2.5.3.1 Sharp objects

Sharp metal objects like screw tips protruding from walls or barrels, bullet strikes through steel barrels or wall frames, or extremely sharp edges on steel targets or props
...
#### 9.2.8.2 RM modification authority

The RM may approve the modification of a stage at any time during or before the event for the purposes of maintaining safety or competitive equity, preserving stage integrity, or related reasons.
...
If possible, all competitors shall be required to complete the revised course of fire per [Section 8.6](<08_Re-Shoots.md#id-8.6-altered-presentation-of-a-stage>) with all previous attempts removed from the match scores.
