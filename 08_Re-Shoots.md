...
Intentionally resetting targets before they are scored is considered cheating, and the RM must be called if suspected. After discussing the situation with the RO Team, the RM will make a decision on any necessary action to take, which may include a **Strike** or **Match DQ** as covered in [Section 13.1](<13_Two-Strike System.md#id-13.1-suspected-cheating-or-unsportsmanlike-conduct>) or [Chapter 15](15_Match%20Disqualifications.md).
...
Intentionally losing eye or ear protection mid-stage to be awarded a re-shoot is considered cheating, and the RM must be called if suspected. After discussing the situation with the RO Team, the RM will make a decision on any necessary action to take, which may include a **Strike** or **Match DQ** as covered in [Section 13.1](<13_Two-Strike System.md#id-13.1-suspected-cheating-or-unsportsmanlike-conduct>) or [Chapter 15](15_Match%20Disqualifications.md).

## 8.6 Altered Presentation of a Stage

### 8.6.1 Mandatory Reshoot
...
### 8.6.2 Competitive Equivalence Exceptions

#### 8.6.2.1 Equivalent Presentations
...
#### 8.6.2.2 Equivalent Substitutions
...
See [Section 7.11](<07_Stage Procedures.md#id-7.11-squibs>)

## 8.8 “Stop!” calls where the RO suspects a safety issue

Similarly to accidental loss of eye/ear protection, a Reshoot must be issued when an RO stops a competitor for a non-DQ safety issue. See [Section 5.1.9.1](<05_Range Commands.md#id-5.1.9.1-when-to-issue-stop>).
