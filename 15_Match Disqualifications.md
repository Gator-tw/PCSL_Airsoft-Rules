...
If at any point the muzzle of a non-inert firearm points at any part of the competitor’s person or other person, the competitor shall be disqualified from the match.

#### 15.3.1.1 Intentional Behavior

The inert firearm exception to the above rule is intended for leniency during the slung condition or normal aggressive movement and gun handling during a stage. Intentionally flagging another person with an inert firearm remains grounds for match disqualification.
...
If the competitor points a non-inert firearm uprange of the designated 180 plane for the bay (by default: perpendicular with the direction of the bay at the competitor’s position), or other modified safety angle as defined by the WSB, they will receive a **Match DQ**.
...
Per [Section 1.2](<01_Range Safety & Procedures.md#id-1.2-cold-range>)
...
Per [Section 7.7](<07_Stage Procedures.md#id-7.7-abandoning-dumping-of-firearms>)
...
In a single event (see [Chapter 14](14_Stage%20Disqualifications.md)).

## 15.11 Using prohibited ammunition

Per [Section 2.8](<02_Competitor Equipment.md#id-2.8-ammunition-restrictions>).
