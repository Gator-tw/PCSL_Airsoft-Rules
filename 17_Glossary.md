...
A plane, typically perpendicular to the direction of the bay at the competitor’s position, where the safe muzzle direction for the stage is defined to be downrange of this plane. See [Section 15.4](<15_Match Disqualifications.md#id-15.4-breaking-the-180-or-other-modified-safety-angle-for-the-course-of-fire>).

### 17.1.2 AD

Accidental Discharge. An unintended discharge of a firearm, which results in a **Match DQ**. See [Section 15.1](<15_Match Disqualifications.md#id-15.1-accidental-discharge-ad>).
...
A range status where all firearms must remain free of live ammunition unless under the direct supervision of an RO or in a designated function fire area. See [Section 1.2](<01_Range Safety & Procedures.md#id-1.2-cold-range>).
...
Disqualification. Can be a **Stage DQ** ([Chapter 14](14_Stage%20Disqualifications.md)) or **Match DQ** ([Chapter 15](15_Match%20Disqualifications.md)).

### 17.1.13 ECI

Empty Chamber Indicator. A flag inserted into the action of a firearm to demonstrate it is unloaded. See [Section 1.5](<01_Range Safety & Procedures.md#id-1.5-empty-chamber-indicators-ecis-chamber-flags>).
...
### 17.1.23 Muzzle Brake

Any muzzle device that features at least one set of externally visible braking baffles for which the uncompromising purpose is to reduce recoil force, rather than compensate for muzzle rise or act as a flash hider. Examples:
...
### 17.1.28 Pistol / Handgun

These terms may be used interchangeably. “Pistol” in the context of this rulebook shall always refer to a handgun type firearm, and not a rifle in a pistol configuration.
...
### 17.1.40 Sweeping / Flagging

Pointing the muzzle of a firearm at any part of one’s own person or another person. See [Section 15.3](<15_Match Disqualifications.md#id-15.3-flagging-sweeping>).
