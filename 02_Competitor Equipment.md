...
If a competitor’s belt and/or holster becomes unsecured from their person, the 180 rule ([Section 15.4](<15_Match Disqualifications.md#id-15.4-breaking-the-180-or-other-modified-safety-angle-for-the-course-of-fire>)) applies to the holstered handgun with a 3 ft exclusion radius from the midpoint of the competitor’s feet. Competitors have the option to correct these issues on the clock as long as the holstered handgun remains under direct physical control of the competitor continuing to adhere to the 180 rule, otherwise a “Stop!” call shall be made and the situation must either be handled via [Section 15.2](<15_Match Disqualifications.md#id-15.2-dropping-a-loaded-firearm>) (loaded firearm) or [Section 14.2](<14_Stage Disqualifications.md#id-14.2-dropping-an-unloaded-or-inert-firearm>) (unloaded firearm).
...
### 2.5.1 Caliber swaps on rifle platforms

Caliber swaps specifically on the rifle platforms may only be made within the same caliber class as defined below:
...
If used, see [Section 14.10](<14_Stage Disqualifications.md#id-14.10-using-a-prohibited-firearm-or-accessory>).
...
Violating the full-auto or simulated full-auto prohibitions shall also receive a **Strike** ([Section 13.1.4](13_Two-Strike%20System.md))

## 2.8 Ammunition Restrictions

If used, see [Section 15.11](15_Match%20Disqualifications.md).
...
Firearms that do not fire without a magazine inserted may present issues during the unload and show clear process ([Section 5.1.5](05_Range%20Commands.md)) or the engagement of DMT targets ([Section 7.5](<07_Stage Procedures.md#id-7.5-drop-mag-target-dmt-procedure>)). Reference the following procedures for these scenarios with this type of firearm:
...
IWB (Inside the Waistband) holsters follow standard requirements as outlined in [Section 2.1.4](#id-2.1.4-holster-position). There is no restriction on positioning of IWB ammunition carriers.
